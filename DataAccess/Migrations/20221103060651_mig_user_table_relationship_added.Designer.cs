...
namespace DataAccess.Migrations
{
    ...
    [Migration("20221103060651_mig_user_table_relationship_added")]
    partial class mig_user_table_relationship_added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Concrete.MessageFk", b =>
                {
                    b.Property<int>("MessageFkId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("MessageFkId");

                    b.HasIndex("ReceiverId");

                    b.HasIndex("SenderId");

                    b.ToTable("MessageFks");
                });
            ...
            modelBuilder.Entity("Entities.Concrete.MessageFk", b =>
                {
                    b.HasOne("Entities.Concrete.Writer", "WriterReceiver")
                        .WithMany("WriterReceiver")
                        .HasForeignKey("ReceiverId");

                    b.HasOne("Entities.Concrete.Writer", "WriterSender")
